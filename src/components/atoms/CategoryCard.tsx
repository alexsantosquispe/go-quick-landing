  ...
  return (
    ...
    >
      {isLarge ? (
        ...
        <div className="flex h-[10.3125] w-[10.3125rem] items-center justify-center rounded-full border-3 border-white p-2 transition-all duration-200 hover:scale-110">
