    ...
    <div className="flex w-full justify-center">
      <div className="flex w-[82.5rem] flex-col items-center gap-9 py-20">
        <div className="flex items-center justify-between gap-x-[6.625rem]">
          <div className="flex w-full rounded-4xl bg-amber-100/70 px-[4rem] dark:bg-neutral-800">
            <div className="h-[30.9375rem] w-[30.9375rem]">
              <img
                src="/img/phone.webp"
                className="h-[30.9375rem] w-[30.9375rem] transition-all duration-300 hover:scale-110 dark:brightness-90"
